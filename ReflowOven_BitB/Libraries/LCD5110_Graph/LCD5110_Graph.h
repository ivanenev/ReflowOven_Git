...
*/
#ifdef ARDUINO_ARCH_[upercase(architecture)]
...
{
	public:
		LCD5110(int SCK, int MOSI, int DC, int RST, int CS, int LED);    // added LED PIN
	...
	protected:
		regtype			*P_SCK, *P_MOSI, *P_DC, *P_RST, *P_CS, *P_LED; // *P_LED added
		regsize			B_SCK, B_MOSI, B_DC, B_RST, B_CS, B_LED;  // B_LED added
